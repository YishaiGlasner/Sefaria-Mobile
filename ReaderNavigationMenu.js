              ...
              <CategoryBlockLink
                ...
                onLongPress={() => {
                  ...
                  (buttonIndex) => {
                    ...
                    (typeof c.refs == 'undefined') ? openUri('https://www.sefaria.org/{c.url}') : openRef(c.refs[buttonIndex]);
                  })
                }}
                onPress={() => { (typeof c.refs == 'undefined') ? openUri('https://www.sefaria.org/{c.url}') : openRef(c.refs[0]); }}
              />
            </View>
          ))}
        </TwoBox>
